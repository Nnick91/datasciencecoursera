plot4 <- function(){
  ...
  par(mfrow = c(2,2))
  plot(rdata[,1], as.numeric(as.character(rdata[,3])), type = "l", xlab = "", ylab = "Global Active Power")
  plot(rdata[,1], as.numeric(as.character(rdata[,5])), type = "l", xlab = "datetime", ylab = "Voltage")
  ...
  plot(rdata[,1], as.numeric(as.character(rdata[,4])), type = "l", xlab = "datetime", ylab = "Global_reacive_power")
  dev.off()
}